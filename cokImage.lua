...
function csbPath( filePath )
	local fileinfo = util.pathinfo(filePath)
	-- if fileinfo.extname ==  then 
		print(string.format("<Project Name=\"%s\" Type=\"Layer\" />",fileinfo.filename))
	-- end
end

--ger csb 
-- util.scanDir("/Users/zj/Desktop/未命名文件夹",10,csbPath)
